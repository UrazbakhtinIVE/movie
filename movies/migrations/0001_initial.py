    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word_premiere', models.DateTimeField(default=datetime.date.today, verbose_name='Примьера в мире')),
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в доларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='сбор в США')),
                ('fees_in_wordl', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='сбор в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('directors', models.ManyToManyField(related_name='firm_director', to='movies.Actor', verbose_name='режиссер')),
